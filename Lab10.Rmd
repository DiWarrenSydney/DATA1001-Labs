...
Suppose we have a coin that we suspect is biased towards heads. Out of 30 tosses we had 21 heads. Using a simulation method with 1000 trials, find an approximate p-value where we have the following null and alternative hypotheses:
$$H_0:P_{heads}\leq0.5$$
$$H_1:P_{heads}>0.5$$
...
totals = replicate(1000, sum(sample(box, 30, replace = TRUE)))   # Run 1000 trials of 30 coin tosses
p_value = mean(totals >= 21)
p_value
```
</details>
