...
bac$residuals = bac$predicted_values - bac$BloodAlcoholConcentration
...
**Demonstration of raw vs orthogonal polynomials, remove from final version**
...
poly_model2 = lm(BloodAlcoholConcentration ~ poly(TimeHours, 3, raw=T), data = bac)

# Add the residuals to the bac data frame
bac$predicted_values = predict(poly_model)
bac$predicted_values2 = predict(poly_model2)
bac$residuals = bac$predicted_values - bac$BloodAlcoholConcentration
bac$residuals2 = bac$predicted_values2 - bac$BloodAlcoholConcentration

# Plot the residuals using ggplot and add a line at y = 0.01 to make it easy to see how many are above this line.
ggplot(bac, aes(x=TimeHours)) + geom_point(aes(y = residuals), colour = "black") + geom_point(aes(y=residuals2), colour = "blue") + geom_line(aes(y = 0.01), colour="red")
```
