...
Using the BAC data set, fit a polynomial model to the data of order 3. Next calculate the residuals of the fitted model to the data and plot them using `ggplot`. How many of the residuals are greater than 0.01?
